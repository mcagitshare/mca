...
import com.mca.DailyTaskReceiver;
import com.mca.ExceptionHandlerActivity;
...
public class DemoApplication extends Application {
    ...
    public static void setDailyTask(Context context) {
        ...
        boolean isTempFileWorking = (PendingIntent.getBroadcast
                (
                        context,
                        Constants.RECEIVER_DAILY_TASK,
                        intentTempFile,
...
//            }else {
                Utils.storeRequestPayloadData(this, Utils.country, "India");
//            }
