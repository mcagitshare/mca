...
public class OtpActivity extends AppCompatActivity {
    ...
    String reg_id, crc, message_server, message_server_port;
    int responseCode;
    ...
    private class AsyncTaskRunner extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            try {
                ...
                reg_id = job.getString("regid");
                crc = job.getString("crc");
                message_server = job.getString("messageserver");
                message_server_port = job.getString("messageserverport");
            } catch (Exception e) {
                e.printStackTrace();
            }
        ...
        protected void onPreExecute() {
            progressDialog = ProgressDialog.show(OtpActivity.this,
                    "ProgressDialog", "Hold on! We are Verifying your OTP");
        }
