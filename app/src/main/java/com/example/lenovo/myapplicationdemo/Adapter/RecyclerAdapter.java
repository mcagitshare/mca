package com.example.lenovo.myapplicationdemo.Adapter;
...
import com.example.lenovo.myapplicationdemo.Activity.ContactListActivity;
...
public class RecyclerAdapter extends RealmRecyclerViewAdapter<Item, RecyclerAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        ...
        if (obj.getDataList() != null) {
            if (obj.getDataList().getGrade() != null) {
                holder.item_name.setText(obj.getName() + " - " + obj.getDataList().getGrade());
            } else {
