...
public class JsonJobInsert extends Job {
    private String edt_title, edt_number;
    private String image, id;

    public JsonJobInsert(String id,String image, String edtTitle, String edtNumber) {
        super(new Params(1));
    ...
    public void onAdded() {
        ...
        try {
            ...
            realmClass.addDate(realm, id, image, edt_title, edt_number);
        } catch (Exception ex) {
        } finally {
            if (realm != null) {
                realm.close();
